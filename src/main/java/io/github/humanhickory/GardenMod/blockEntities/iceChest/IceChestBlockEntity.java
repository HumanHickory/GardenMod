package io.github.humanhickory.GardenMod.blockEntities.iceChest;
...
public class IceChestBlockEntity extends RandomizableContainerBlockEntity {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            IceChestBlockEntity.this.playSound(p_155064_, SoundEvents.BARREL_OPEN);
            IceChestBlockEntity.this.updateBlockState(p_155064_, true);
        }
        ...
        protected boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == IceChestBlockEntity.this;
            } else {
                return false;
            }
        }
    ...
    protected Component getDefaultName() {
        return Component.literal("Ice Chest");
    }
    ...
    void updateBlockState(BlockState pState, boolean pOpen) {
        this.level.setBlock(this.getBlockPos(), pState.setValue(IceChestBlock.OPEN, Boolean.valueOf(pOpen)), 3);
    }

    void playSound(BlockState pState, SoundEvent pSound) {
        Vec3i vec3i = pState.getValue(IceChestBlock.FACING).getNormal();
